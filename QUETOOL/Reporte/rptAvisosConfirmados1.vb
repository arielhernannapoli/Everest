...
Public Class rptAvisosConfirmados2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAvisosConfirmados.rpt"
        End Get
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QUETOOL.rptAvisosConfirmados.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_FiltroEjercicio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAvisosConfirmados2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAvisosConfirmados = New rptAvisosConfirmados
        rpt.Site = Me.Site
        Return rpt
    End Function
