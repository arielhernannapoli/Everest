...
Public Class rptAudienciaRadio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QUETOOL.rptAudienciaRadio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAudienciaRadio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAudienciaRadio = New rptAudienciaRadio
        rpt.Site = Me.Site
        Return rpt
    End Function
