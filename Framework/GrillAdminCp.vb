...
Public Class GrillAdminCp
    ...
    Private Sub CrearBanda(ByRef Ds As UltraDataSource, ByVal NombreBanda As String, ByVal Columnas As ArrayList)
        ...
        Dim T As CampoTipos, i As Int32
    ...
    Private Sub ActualizarSpotDetalle(ByVal SpotDetalle As DataTable, ByVal Temas As DataTable, ByVal Fila As FilaTemas, ByVal Fecha As Date, ByVal Letras As String, ByVal IDSpot As Integer)
    ...
    Public Sub ActualizarDataTableColumnasManuales(ByVal Spots As DataTable, ByVal Fila As UltraDataRow)
        ...
        Catch ex As IndexOutOfRangeException
            Throw New Exception("GrillAdminCp.ActualizarDataTableColumnasManuales: El IDSpot No Existe")
        Catch ex As Exception
    ...
    Public Sub ActualizarNeto(ByVal Fila As UltraDataRow, Optional ByVal Col As String = "", Optional ByVal NuevoValor As Object = Nothing, Optional ByVal IDConvenio As Integer = 0, Optional ByVal AplicandoConvenio As Boolean = False)
        ...
        If Col = "cpr" Then ' 
            Fila.Item("cpr") = Valores.CastDBNull(NuevoValor)
            If Fila.Item("rat_tanda_target_1") <= 0 Then
                Fila.Item("neto") = Fila.Item("Bruto")
                Fila.Item("dcto1") = 0
                Exit Sub
            End If
            Fila.Item("dcto1") = Valores.Redondear((100 * (Fila.Item("Bruto") - Fila.Item("cpr") * Fila.Item(ColumnaRatingTarget1)) / Fila.Item("Bruto")))
            If Fila.Item("dcto1") <= 0 Then
                Fila.Item("dcto1") = -1
                Exit Sub
            ElseIf Fila.Item("dcto1") = 100 Then
                Fila.Item("dcto1") = 0
                Exit Sub
            End If
        ...
        If Col = "bruto" Then
            ...
            If Fila.Item("bruto") <= 0 Then
                Fila.Item("neto") = Fila.Item("bruto")
                Fila.Item("dcto1") = 0
                Fila.Item("cpr") = 0
            End If
            If Fila.Item("cpr") <= 0 Or Fila.Item(ColumnaRatingTarget1) <= 0 Then
                If Fila.Item("dcto1") = 0 And Fila.Item("dcto2") = 0 And Fila.Item("dcto3") = 0 And Fila.Item("dcto4") = 0 And Fila.Item("dcto5") = 0 Then
                    Fila.Item("neto") = Fila.Item("Bruto")
                    Exit Sub
                End If
            End If
        ...
        If Col = "rat_tanda_target_1" Then
            Fila.Item("rat_tanda_target_1") = Valores.CastDBNull(NuevoValor)
            If Fila.Item("cpr") <= 0 And Fila.Item("rat_tanda_target_1") <= 0 Then
                Fila.Item("neto") = Fila.Item("Bruto")
                Fila.Item("dcto1") = 0
                Exit Sub
            End If
            If Fila.Item("Bruto") = 0 Then ' Esto se hace para que si el bruto, cpr es = Cero no ponga infinito en la celda de descuento
                Exit Sub
            End If
            Fila.Item("dcto1") = Valores.Redondear((100 * (Fila.Item("Bruto") - Fila.Item("cpr") * Fila.Item(ColumnaRatingTarget1)) / Fila.Item("Bruto")))
            If Fila.Item("dcto1") <= 0 Then
        ...
        For Each Ur In Origen.Rows
            ...
            For Each S In Columnas
                ...
                Try
                    ...
                    End If
                Catch ex As ArgumentException
                    Mensajes.Mensaje("GrillAdminCp.ActualizarDataTable" & vbCrLf & "El Key '" & S & "' No Existe.", TipoMensaje.DeError)
                Catch ex As IndexOutOfRangeException
